//Quick Sort: Método que segue a metodologia “dividir e conquistar”, dividindo sua lista 
//de entrada em duas sublistas a partir de um elemento escolhido como para em 
//seguida realizar o mesmo procedimento nas duas listas menores até uma única 
//lista. 

//- Performance: Considerado o método de ordenação interna mais rápido existente.
//Possui complexidade de C(n) = O(n log n) para melhor caso e C(n) = O(n²) para 
//pior caso.
...
void perfrom_merge(int val[], int counter11, int counter12, int counter22, 
int counter21); //
...
int main(){
    ...
    printf("\n Saída gerada após o uso do quick sort \n");
